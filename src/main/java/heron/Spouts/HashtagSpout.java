...
/* A Spout to collect Tweets from Twitter Firehouse*/
public class HashtagSpout extends BaseRichSpout
{
    ...
    public HashtagSpout(String key, String secret) {
        _custkey = key;
        _custsecret = secret;
    }
    public HashtagSpout(String key, String secret, String token, String tokensecret) {
        _custkey = key;
        _custsecret = secret;
        _accesstoken = token;
    ...
    public void nextTuple() {
        ...
        if(nexttweet==null) {
            ...
            if (nexttweet.getLang().contentEquals("en"));
            {
                _collector.emit(new Values(nexttweet.getText()));
            }
