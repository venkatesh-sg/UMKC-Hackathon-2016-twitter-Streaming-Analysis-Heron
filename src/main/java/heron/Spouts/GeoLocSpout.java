...
public class GeoLocSpout extends BaseRichSpout
{
    ...
    public GeoLocSpout(String key, String secret) {
        _custkey = key;
        _custsecret = secret;
    }
    public GeoLocSpout(String key, String secret, String token, String tokensecret) {
        _custkey = key;
        _custsecret = secret;
        _accesstoken = token;
    ...
    public void nextTuple() {
        ...
        if(nexttweet==null) {
            ...
            if(nexttweet.getGeoLocation()!= null){
                _collector.emit(new Values(nexttweet.getGeoLocation().getLatitude(),nexttweet.getGeoLocation().getLongitude()));
            }
